...
<div style="display: flex; align-items: center;">
    ...
    <a href="https://scholar.google.com/citations?user=IzLbtxcAAAAJ&hl=en" target="_blank" style="margin-left: 10vw;">
        <img src="{{ '/images/Google_scholar.jpg' | relative_url }}" alt="Google Scholar logo" style="height: 100px;" media = "min-width: 25vw;">
    </a>
    <a href="https://www.researchgate.net/profile/Christopher-Johnson-41" target="_blank" style="margin-left: 5vw;">
        <img src="{{ '/images/Research_gate.png' | relative_url }}" alt="Research Gate logo" style="height: 100px;" media = "min-width: 25vw;">
    </a>
</div>
